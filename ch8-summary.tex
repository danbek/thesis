...
Solving the optical efficiency problem requires understanding where in the optical chain the efficiency loss occurs.
...
Possibilities include segmented mirrors (which have proven successful for larger apertures \cite{fowler_optical_2007}), aluminized plastic mirrors, or a large-diameter Fresnel lens \cite{black_millimeter-wave_1987}.
...
One promising detector technology is the Microwave Kinetic Inductance Detector (\MKID).
...
Like \TES\ detectors, \MKIDs\ use superconducting materials at low temperatures, but the principle of operation is different.
