...
\figref{fig:ch8-multi-chroic} shows a photograph of a polarization-sensitive detector developed by a collaboration of which the author of this dissertation is a part \cite{datta_horn_2014}.
...
The overall system size is set by the standoff distance and desired spatial resolution, which directly determine the size of the optical aperture via the Rayleigh criterion (\eqnref{eqn:ch1-raleigh}).
