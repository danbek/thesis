...
\figref{fig:ch7-heater-r-plots} explains this idea further by a series of plots.
...
Data averaged over 32 steps (16 up and 16 down) along with best fit to \eqnref{eqn:ch7-heater-step-trans}.
...
\figref{fig:ch7-trans-noise-model-plots} plots the measured noise spectrum for \RCm{31}{1} at normal operating conditions, along with the basic model spectrum and a spectrum that includes enough additional ``power'' noise to match the measured whit noise level at low frequencies.
