...
Once calibrated, these heaters allow us to take full \IV\ curves at all bath temperatures, allowing measurements of the detector thermal conductance $G$, critical temperature $T_c$ and xxx $n$.
...
The seven heaters for columns 0 and 1 have a mean of \SI{23.8}{\ohm} with a standard deviation of \SI{0.26}{\ohm} xxx check values
...
With knowledge of the heater resistances, \IV\ curves can be taken over a wide range of bath temperatures, which enables a measurement of the \TES\ thermal conductance $G$, critical temperature $T_C$ and xxx $n$.
...
\figref{fig:ch7-bias-step-plots} and \figref{fig:ch7-bias-step-results} show the result of these measurements being taken for the four detectors on column 0 with good heaters.
...
\figref{fig:ch7-trans-noise-model-plots} plots the measured noise spectrum for \RCm{31}{1} at \SOC.
...
It is also possible that a much higher level in-band optical power is falling on the detector.
