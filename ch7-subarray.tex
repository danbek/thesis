...
As shown in \figref{fig:ch7-teff-si-pred}, most detectors have $\tau_{eff}$ close to \SI{1.25}{\ms}, with only a few slower than this.
...
The results of these measurements, as well as the ratio of the calculated to measured values, are shown in \figref{fig:ch7-heater-step-pred-plots}.
...
\figref{fig:ch7-trans-noise-model-plots} plots the measured noise spectrum for \RCm{31}{1} at \SOC, along with the basic noise model and a noise model that includes enough additional power noise to match the measured white noise level at low frequencies.
