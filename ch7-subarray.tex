...
\figref{fig:ch7-servo-tau-est} shows the impact of the servo rolloff on estimation of time constants from single-pole response functions.
...
\figref{fig:ch7-servo} shows the resulting white noise levels and $\tau_{servo}$ values for a range of servo gain values $I$.
...
\figref{fig:ch7-cm-plots} contains several plots relating to this.
