...
Assuming a circular scan, the maximum far-field displacement of the on-axis point will be $\SI{3.5}{\mm} \times \SI{0.276}{\degree\per\mm} \times \SI{19.33}{\cm\per\degree} = \SI{18.7}{\cm}$.
