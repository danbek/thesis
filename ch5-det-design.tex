...
The invar plates must be attached to the Al platter in a way that account for the differential thermal contraction between Al and Invar, while ensuring that the detectors are aligned properly to the feedhorns.
This is accomplished by aligning the invar, feedhorns, and Al platter to each other using stainless steel dowel pins.
...
\caption{
  Photograph of the alignment jig used to properly align the \Imager's sub-array to the invar plate.
