...
All columns are below \SI{1.0}{ms} at $I = 20$.
...
Electrical detector time constants are \abt~\SI{3.7}{ms} in the superconducting state, and \abt~\SI{0.1}{ms} in the normal state.
While biased into the transition, $\tau_{eff}$ is in the range xxx to xxx.
