...
The noise below \SI{30}{\Hz} is 1.5--2.5 times higher with the \PTC\ on, but the total standard deviation of the relevant frequencies of $f >= \SI{6}{\Hz}$ is only \SI{2.6}{\percent}.
}
