...
To check this I acquired data for the full array at the normal rate of \SI{3125}{\hertz} and for column 0 at \SI{15625}{\hertz}.
...
\end{equation}
where $S_{I,\SI{3125}{\Hz}}$ and $S_{I,\SI{15625}{\Hz}}$ are the measured current noise power spectral densities at the two different multiplexig rate, expressed in units of \si{\A^2 \per \Hz}.
The sums are performed only over those frequency components in the range \SIrange{3125}{15625}{\Hz}, and note that $\Delta f$ is different for the two sampling rates.
...
The error bars are for \SI{95}{\percent} confidence intervals, and the average excess noise is \SI{15}{\percent}.
\textbf{Bottom}
