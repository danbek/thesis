...
The earliest verion of the cryostat used for this project used a Gifford-McMahon (\GM) cryocooler, which vibrates the cryostate significantly more than a \PTC\ does.
Prototype detectors had significantly higher noise levels with the \GM\ cooler running than when it was out; in addition the dector noise could be directly increased by striking the side of the cryostat with a soft mallet while the \GM\ cooler was turned off.
...
\figref{fig:xxx} shows current noise power spectra for the four detectors with good heaters on column 0, with the \PTC\ both on and off.
