...
For the other 32 columns I fit noise power spectra to an equation of the form
\begin{equation}
...
The bottom plots in \figref{fig:ch8-servo} show the resulting values of $\tau_{servo}$ for all rows and all columns, for $I = 40$ and $I = 60$.
...
When taking images, $I=10$ has often been used; the impact of this choice on image quality is discussed in \sectionref{xxx}.
