...
\begin{tabular}{rr}
  ...
  \begin{tikzpicture}[trim axis left]
	\begin{axis}[xmin=0,ymin=0,xmax=25,
	  ...
	  \addplot+[only marks, mark size=1pt] table[x=t,y=exact]{../data/ch8-servo-est-tau-example.dat};
	  \addplot+[only marks, mark size=1pt] table[x=t,y=filtered]{../data/ch8-servo-est-tau-example.dat};
	  \addplot+[mark=none, line width=2pt] table[x=t,y=fit]{../data/ch8-servo-est-tau-example.dat};
	\end{axis}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[trim axis right]
	\begin{loglogaxis}[xmin=1e-2,xmax=1,ymin=1e-5,ymax=1,
	  ...
	  \addplot+[mark=none,line width=2pt] table[x=tauratio,y=err]{../data/ch8-servo-est-tau-err.dat};
	\end{loglogaxis}
  \end{tikzpicture}
