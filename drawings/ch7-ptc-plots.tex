...
\pagestyle{empty}
  ...
  \begin{tikzpicture}[trim axis left]
	\begin{axis}[
	  ...
	  \addplot [hist={data min=0.9,data max=1.15,bins=20},
		        fill=blue!75]
	  table[y=6up]{../data/ch7-ptc-plots.dat};
	\end{axis}
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[trim axis left]
	\begin{loglogaxis}[%xmin=2.8,xmax=5,
	  ...
	  \addplot+[mark=none] table[x=fs,y=Pxxs]{../data/ch7-ptc-ps-plots.dat}; \addlegendentry {\PTC\ On}
	  \addplot+[mark=none] table[x=fs,y=Pxxnos]{../data/ch7-ptc-ps-plots.dat}; \addlegendentry {\PTC\ Off}
	\end{loglogaxis}
  \end{tikzpicture}
