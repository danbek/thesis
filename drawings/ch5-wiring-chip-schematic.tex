...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[height=3.0in]{../images/ch5-wiring-chip-schematic.png}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
       ...
       \draw[black,ultra thick,<->] (.5,0.35) -- (0.8,0.35) node[midway,below] {xxx in}; % scale bar --- interace chip is 0.323 picture units long
    \end{scope}
\end{tikzpicture}
