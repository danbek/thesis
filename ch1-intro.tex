...
The acknowledgments at the end of \chapterref{c:sys-design} and \chapterref{c:det-design} highlight important contributions from other people both at \NIST\ and elsewhere.
