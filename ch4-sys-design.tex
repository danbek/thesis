...
Vibration of the cryostat can lead to temperature fluctuations of the \SI{1}{\K} cold stage, or to microphonic pickup either directly in the detectors themselves or in the readout circuitry, leading to much higher detector noise (see \sectionref{sec:ch6-microphonic-pickup}).
...
This will need to be lengthened in a future design iteration for practical device operation.
...
\chapterref{c:imaging} presents maps of both a \SI{0.2}{\in} and \SI{1.791}{\cm} sources.
