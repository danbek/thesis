...
The cryostat window is a high-density polyethylene (\HDPE) lens that makes the system telecentric; this maens that focal surface of the system inside the cryostat is planar, not curved, and simplifies the design of the focal plane.
...
\tableref{tab:xxx} lists imporant properties and parameters for the different parts of the optical system.
