...
There are two points worth noting about \eqnref{ch4-photon-nep}.
...
The correct generalizations of \eqnref{eqn:ch4-power-per-mode} and \eqnref{ch4-photon-nep} is to treat the term $\eta(\nu) n(\nu,T)$ as an total photon occupation number that includes contributions from all sources.
