...
\figref{fig:ch4-hfss-model} shows a schematic of the \HFSS\ model, including the fields travelling down the waveguide. The model has the following features:
\begin{itemize}
...
\item To keep the design simple, the backshort walls are not metalized.
      ...
      This is accounted for in the simulation.
\item The exact PdAu mesh used in the fabrication was included.
