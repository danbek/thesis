...
\begin{figure*}
\centering
\includegraphics[width=3.0in]{./drawings/ch4-feed-spill.pdf}
\caption{
...
In fact, as \figref{fig:ch4-netd-vs-nfeeds} shows, an even larger number of even smaller feedhorns is predicted to reduce \NETD\ by \SI{3}{\percent}.
However, as mentiond above, the maximum number of detectors that can be readout by our system is 1024, so $D = 0.108$\,mils (\SI{2.73}{\mm} cold) was chosen as the optimal feedhorn diameter.

\begin{figure*}
\centering
\includegraphics[width=3.0in]{./drawings/ch4-netd-vs-nfeeds.pdf}
\caption{
  ...
  \NETD\ is minimized with 20 feedhorns per side, giving a total of 1580 feedhorns of diameter \SI{2.185}{\mm} (cold), but the \Imager\ uses 1004 feedhorns of diameter \SI{2.73}{\mm} (cold) because of readout limitations.
}
