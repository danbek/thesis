...
The \PTC\ 2nd stage is connected to the ``4 K'' Cold Plate by a large (3.0 in diameter by 2.78 in long) cylinder of CDA-110 Cu\footnote{This cryostat was originally designed to work with a different cryocooler. The \PTC\ currently installed had a shorter distance between the 1st and 2nd stages; the Cu cylinder takes up this extra space.}, followed by tube of alloy CDA-101 Cu followed by a set of  CDA-101 copper braids.
...
\caption{
  ...
  The ``Ti-6Al-4V spiders'' provide the structural link between the \SI{1}{\K} cold stage and the \SI{4}{\K} cold plate.
