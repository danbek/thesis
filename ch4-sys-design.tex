...
Finally, the choice of readout system and wiring places a firm upper limit on the number of detectors in the system of 1024.
...
\caption[\HFSS\ model]{
  ...
  But close examination shows that the wire perpendicular to the excited polarization have very current, while those parallel have higher current.
