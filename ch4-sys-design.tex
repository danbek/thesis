...
\caption{
  ...
  The blue dashed vertical line at \SI{283}{\GHz} indicates the cutoff frequency of the next-highest-order mode, TM01; \SI{0.9}{\precent} of the bandwidth is above this frequency.
}
