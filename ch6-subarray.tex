...
\end{equation}
where $V_0$ is the voltage across the \TES\ at the bias point, $R_0$ is the resistance of the \TES\ at the bias point, $R_{sh}$ is the bias circuit shunt resistance, and the assumption of zero parasitic resistance has been made.
