...
As discussed in \sectionref{sec:ch4-coupling}, another possible explanation for the elliptical beams could be misalignment between the detectors and the feedhorns.
