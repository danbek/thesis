...
Given the fact that responsivity will increase with optical loading, which leads to underestimates of temperature difference via \eqnref{eqn:ch7-I-to-T}, these numbers are in reasonable agreement, indicating that the temperature scale is accurate to withing \abt{\SI{20}{\percent}}.
