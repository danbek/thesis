...
% that quantitative.
In \sectionref{sec:ch4-feedhorn-design}, it was shown that the expected \FWHM\ beam width from this measurement is \SI{1.2}{\cm}, about \SI{15}{\percent} smaller than observed.
