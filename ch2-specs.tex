...
The system is intended to be used to take images of a variety of concealed weapons and other objects, hidden beneath many different types of clothing, in both indoor and outdoor scenarios.
...
See \tableref{tab:ch2-sys-compare} for summary details of these and other security imaging systems.
