...
The row/column combinations that show no response indicate either a broken detector line, a broken SQUID on a mux chip, or some other problem in the readout system.
\tableref{tab:det-cuts} lists all detectors cut due to a failure to respond to \TES bias ramps.
