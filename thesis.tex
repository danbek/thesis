...
\figref{xxx} shows histogram plots of the resulting \Rsh\ and $L$ values.
...
\begin{figure*}
\centering
\input{drawings/ch8-rsh-hist.tex}
\caption{xxx}
\label{fig:rsh-hist}
\end{figure*}
...
\begin{figure*}
\centering
\input{drawings/ch9-detector-cuts-wafer.tex}
\caption{
...
\begin{figure*}
\centering
\input{drawings/ch9-detector-cuts-rc.tex}
