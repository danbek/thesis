...
\usepackage{enumitem} % xxx what is this for?
...
\centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.4\textwidth]{images/he4-sorp-fridge-cutaway.png}};
