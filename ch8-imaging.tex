...
To convert actuator displacement to displacements in the far-field of the system, we use \eqnref{eqn:ch5-bose-to-x} and \eqnref{eqn:ch5-bose-to-y}, subsituting $d = I \times \text{conversion factor}$:
\begin{equation}
