...
In the raw images, the mean total contrast across all frames with the person present is \SI{8.5}{\K}.
...
\end{equation}
about \SI{1.5}{\K} larger than observed.
...
The total contrast in the raw images is \SI{8.5}{\K}, about \SI{1.5}{\K} lower than expected.
