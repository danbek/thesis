...
% xxx should BOSE really be all caps?
...
The result are conversion factors of \SI{2.929}{\mm\per\uA} for \DISP1 and \SI{3.024}{\mm\per\uA} for \DISP2. xxx fewer sig figs?
...
% xxx need to make this equation wrap across lines
\begin{multline}
%\begin{split}
