...
To check the actual distance to the target focal plane, beam maps as described in \sectionref{sec:ch8-beam-maps} were performed with the black-body source located at different distances from the cryostat.
...
Best results were achieved by covering an area around the black-body source with Aluminum foil; this eliminated hot spots in the image due to the warmth of the housing of the black-body source itself.
...
Images were acquired of the cooler itself, as well as the cooler with aluminum foil strips taped to the outside.
...
Given the fact that responsivity will increase with optical loading, which leads to underestimates of temperature difference via \eqnref{eqn:ch8-I-to-T}, these numbers are fairly close.
...
\item The total integration time per pixel is not uniform.
      Some pixels end up receiving more detector samples than others, as shown in \figref{fig:ch8-flat-frame-cnt}.
