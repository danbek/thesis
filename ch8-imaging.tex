...
\begin{multline}
%\begin{split}
  B(x,y) = O + A \exp{ \left[  - \frac{1}{2} \left( \frac{ (x-x_0) \cos{\theta} + (y-y_0) \sin{\theta}}{\sigma_1} \right)^2 
...
\figref{xxx} shows the final beam maps.
...
\begin{figure*}[th]
\centering
\includegraphics[width=\textwidth]{images/ch8-all-beam-maps.pdf}
\caption{
