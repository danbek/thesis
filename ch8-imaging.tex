...
The total temperature contrast in the images of \figref{fig:ch8-single-frames} is \SI{6}{\K}, but as described above higher and low values of temperature have been mapped to \SI{+3}{\K} and \SI{-3}{\K} to improve contrast for display.
